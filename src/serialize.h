...
inline unsigned int GetSerializeSize(char a) { return 1; }
inline unsigned int GetSerializeSize(int8_t a) { return 1; }
inline unsigned int GetSerializeSize(uint8_t a) { return 1; }
inline unsigned int GetSerializeSize(int16_t a) { return 2; }
inline unsigned int GetSerializeSize(uint16_t a) { return 2; }
inline unsigned int GetSerializeSize(int32_t a) { return 4; }
inline unsigned int GetSerializeSize(uint32_t a) { return 4; }
inline unsigned int GetSerializeSize(int64_t a) { return 8; }
inline unsigned int GetSerializeSize(uint64_t a) { return 8; }
inline unsigned int GetSerializeSize(float a) { return 4; }
inline unsigned int GetSerializeSize(double a) { return 8; }
 ...
 * optional
 */
template<typename T> unsigned int GetSerializeSize(const boost::optional<T> &item);
...
unsigned int GetSerializeSize_impl(const std::vector<T, A>& v, const unsigned char&)
{
    return (GetSizeOfCompactSize(v.size()) + v.size() * sizeof(T));
}

template<typename T, typename A, typename V>
unsigned int GetSerializeSize_impl(const std::vector<T, A>& v, const V&)
{
 ...
 */
template<typename T>
unsigned int GetSerializeSize(const boost::optional<T> &item)
{
    if (item) {
